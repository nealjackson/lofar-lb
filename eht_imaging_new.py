...
def main(vis, closure_tels='DE601;DE602;DE603;DE604;DE605;FR606;SE607;UK608;DE609;PL610;PL611;PL612;IE613', npix=128, fov_arcsec=6., zbl=0., prior_fwhm_arcsec=1., doplots=False, imfile='myim', remove_tels='', niter=300, cfloor=0.001, conv_criteria=0.0001, use_bs=False, use_first=False ):
    ...
    if use_first:
        ...
        corrfirst = correlate.correlate(np.array([[ra,dec,]]),0,1,first,0,1,MAXARCMIN/60.0)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_first',action='store_true', help='set to use FIRST for making prior')

    args = parser.parse_args()
    main( args.vis, closure_tels = args.ctels, npix = args.npix, fov_arcsec = args.fov, zbl = args.zbl, prior_fwhm_arcsec = args.prior_fwhm, doplots = args.doplots, imfile = args.imfile, remove_tels = args.rtels, niter=args.maxiter, cfloor=args.clipfloor, conv_criteria=args.convg, use_bs=args.use_bs, use_first=args.use_first )
